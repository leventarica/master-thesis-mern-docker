...
const collectionNamespace = require('mongodb/lib/core/wireprotocol/shared').collectionNamespace;
...
const applyCommonQueryOptions = require('mongodb/lib/core/wireprotocol/shared').applyCommonQueryOptions;
const command = require('mongodb/lib/core/wireprotocol/command');
const decorateWithExplain = require('mongodb/lib/utils').decorateWithExplain;
